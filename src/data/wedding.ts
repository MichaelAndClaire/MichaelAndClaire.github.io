...
export const wedding = {
  ...
  schedule: [
    {
      time: '4:00 PM',
      title: 'Ceremony',
      detail: 'Outdoor Chapel. Please arrive 20-30 minutes early. We also recommend an umbrella or raincoat, just in case!',
    },
    {
      time: '4:30 PM',
      title: 'Cocktail Hour',
      detail: 'Mountainside Lodge Pavillion',
    },
    {
      time: '5:30 PM',
      title: 'Dinner',
  ...
  travel: {
    ...
    elevation:
      'Estes Park is just over 7,500 feet, and the wedding venue is about 8,700 feet above sea level. If you are sensitive to altitude, consider arriving a day or two early and acclimating in lower Front Range cities like Longmont or Boulder. Staying hydrated is essential!',
  },
  mealChoices: ['No restrictions', 'Vegetarian', 'Vegan', 'Other / allergy'],
  registryLinks: [
    {
  ...
  coloradoFavorites: [
    ...
    {
      region: 'Estes Park',
      items: ['Antonio’s Real New York Pizza', 'The Country Market of Estes Park', 'Fresh Burger Stop', 'Indian Bites', 'You Need Pie Diner & Bakery', 'ROCKY MOUNTAIN NATIONAL PARK!!'],
    },
  ],
  faqs: [
    {
